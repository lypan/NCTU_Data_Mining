...
#%% load model
'''
clf1 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/RandomForestClassifier_raw.pkl')
clf2 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/RandomForestClassifier_tfidf.pkl') 
clf3 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/ExtraTreesClassifier_raw.pkl')
clf4 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/ExtraTreesClassifier_tfidf.pkl') 
clf5 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/SGDClassifier_raw.pkl')
clf6 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/SGDClassifier_tfidf.pkl') 
clf7 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/LogisticRegression_raw.pkl')
clf8 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/LogisticRegression_tfidf.pkl') 
clf9 = xgb.Booster({'nthread':8}) 
clf9.load_model("/home/gakaza/NCTU_Data_Mining/model/xgboost_raw.model") 
clf10 = xgb.Booster({'nthread':8}) 
clf10.load_model("/home/gakaza/NCTU_Data_Mining/model/xgboost_tfidf.model") 
clf11 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/KNeighborsClassifier_raw.pkl')
clf12 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/KNeighborsClassifier_tfidf.pkl') 
clf13 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/MultinomialNB_raw.pkl')
clf14 = joblib.load('/home/gakaza/NCTU_Data_Mining/model/MultinomialNB_tfidf.pkl') 
#%% load predict
test_pred1 = np.load("/home/gakaza/NCTU_Data_Mining/model/RandomForestClassifier_raw_predict.npy")
test_pred2 = np.load("/home/gakaza/NCTU_Data_Mining/model/RandomForestClassifier_tfidf_predict.npy")
test_pred3 = np.load("/home/gakaza/NCTU_Data_Mining/model/ExtraTreesClassifier_raw_predict.npy")
test_pred4 = np.load("/home/gakaza/NCTU_Data_Mining/model/ExtraTreesClassifier_tfidf_predict.npy")
test_pred5 = np.load("/home/gakaza/NCTU_Data_Mining/model/SGDClassifier_raw_predict.npy")
test_pred6 = np.load("/home/gakaza/NCTU_Data_Mining/model/SGDClassifier_tfidf_predict.npy")
test_pred7 = np.load("/home/gakaza/NCTU_Data_Mining/model/LogisticRegression_raw_predict.npy")
test_pred8 = np.load("/home/gakaza/NCTU_Data_Mining/model/LogisticRegression_tfidf_predict.npy")
test_pred9 = np.load("/home/gakaza/NCTU_Data_Mining/model/xgboost_raw_predict.npy")
test_pred10 = np.load("/home/gakaza/NCTU_Data_Mining/model/xgboost_tfidf_predict.npy")
test_pred11 = np.load("/home/gakaza/NCTU_Data_Mining/model/KNeighborsClassifier_raw_predict.npy")
test_pred12 = np.load("/home/gakaza/NCTU_Data_Mining/model/KNeighborsClassifier_tfidf_predict.npy")
test_pred13 = np.load("/home/gakaza/NCTU_Data_Mining/model/MultinomialNB_raw_predict.npy")
test_pred14 = np.load("/home/gakaza/NCTU_Data_Mining/model/MultinomialNB_tfidf_predict.npy")
...
#%%
'''
blend_prob = test_pred1 + 1.15*test_pred2 + test_pred3 + test_pred4 + test_pred5 + test_pred6 + 1.3*test_pred7 + 1.3*test_pred8 + 1.3*test_pred9 + 1.5*test_pred10
